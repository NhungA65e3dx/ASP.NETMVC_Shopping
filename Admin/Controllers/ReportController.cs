    ...
    public class ReportController : Controller
    {
        ...
        public IActionResult PrintCoffee()
        {
            using (var context = _dbContext)
            {
                ...
                var reportPath = "D:\\WebASP\\Lab07_ASP.Net\\ReportsApplication2\\Report1.rdlc"; // Đường dẫn tới file template báo cáo RDLC
        ...
        public IActionResult PrintOrder()
        {
            using (var context = _dbContext)
            {
                ...
                var reportPath = "D:\\WebASP\\Lab07_ASP.Net\\ReportsApplication2\\Report2.rdlc"; // Đường dẫn tới file template báo cáo RDLC

                var localReport = new LocalReport(reportPath);
                localReport.AddDataSource("DataSet1", orders); // DataSet1 là tên dataset được định nghĩa trong file RDLC
